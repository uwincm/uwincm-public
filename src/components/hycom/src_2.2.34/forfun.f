...
c ---         map shallow depths to high jerlov numbers
        ...
        write (lp,*)
        write (lp,*) ' dtime,dtime0,dtime1 = ',dtime,dtime0,dtime1
        write(lp,*) 'ESMF dtime,w0,w1 = ',dtime,w0,w1
        write (lp,*)
        write (lp,*) ' ...finished initializing 
     &  forcing fields and weights - ESMF'
        endif !1st tile
        call xcsync(flush_lp)
...
!      w0 = (dtime1-dtime)/(dtime1-dtime0)
!      w1 = 1.0 - w0
! EDIT mcurcic :: dtime0,dtime1 not set which -> w0,w1=-/+Inf
! SET THEM FIXED FOR NOW, BUT,
! TODO: correct when we get time information from ESMF... 
       w0=0.
       w1=1.
...
! copy old atm to slot 1
        ...
        do j= 1-nbdy,jj+nbdy
          do i=1-nbdy,ii+nbdy
            ...
            radflx(i,j,1) =radflx(i,j,2)
            precip(i,j,1) =precip(i,j,2)
            wndspd(i,j,1) =wndspd(i,j,2)
            seatmp(i,j,1) =seatmp(i,j,2)
