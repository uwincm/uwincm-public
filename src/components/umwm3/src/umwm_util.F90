...
PURE FUNCTION meanWavenumber(i) RESULT(wn)
!======================================================================+
!                                                                      !
! Given a spatial grid index i, returns the mean wavenumber            !
! at that location.                                                    !
!                                                                      !
!======================================================================+
USE UMWM_module,ONLY:e,kdk,dth,om,pm, k
...
DO p=1,pm
  DO o=1,om
    wn = wn+e(o,p,i)*kdk(o,i)
    wnaux = wnaux + wn*k(o,i)**0.5
  ENDDO
ENDDO
wn = wn*dth
wnaux = wn*dth
...
ENDFUNCTION meanWavenumber
!======================================================================+



PURE FUNCTION maxHeight(i) RESULT(mheight)
!======================================================================+
!                                                                      !
! Given a spatial grid index i, returns an estimated maximum wave      !
! height at that location.                                             !
!                                                                      !
!                                                                      !
!======================================================================+
USE UMWM_module,ONLY: k,pm,d, hmax_coef
...
INTEGER :: o,p
REAL    :: Ftot, meank, kbard, tanhkd, kbar, mheight

!=======================================================================

kbar = meanWavenumber(i)
kbard = kbar*d(i)
tanhkd = tanh(kbard)
mheight = 1./16.*(hmax_coef*tanhkd/kbar)**2

ENDFUNCTION maxHeight
!======================================================================+
