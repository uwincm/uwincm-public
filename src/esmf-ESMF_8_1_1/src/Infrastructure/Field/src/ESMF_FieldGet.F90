...
! \item[8.1.0] Added argument {\tt ssiLocalDeCount} and {\tt localarrayList} to
...
!------------------------------------------------------------------------------
    ...
    integer :: tileCount, i, j, k
    integer :: dg_dimcount, decount, ldecount
    ...
    integer, allocatable :: dg2gmap(:), dg2fmap(:)
